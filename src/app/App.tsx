      ...
      <footer className="bg-white border-t mt-12">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-sm text-gray-600">
            <p className="text-center font-semibold text-gray-900 mb-2">CONTACTO</p>
            <p className="text-center mb-4">Tel/WhatsApp: 67519672 - 67508791</p>
            <div className="flex justify-center gap-3">
              <a
                href="https://wa.me/59167519672"
                target="_blank"
